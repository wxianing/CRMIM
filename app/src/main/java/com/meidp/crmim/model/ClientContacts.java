...
public class ClientContacts implements Serializable {
     ...
     * WorkTel : sample string 11
     * MailAddress : sample string 12
     * HomeTel : sample string 13
     * QQ : sample string 14
     * HomeAddress : sample string 15
     * Age : sample string 16
     * birthcity : sample string 17
     * CanViewUser : sample string 18
     * CanViewUserName : sample string 19
     * Creator : 1
     * CreatedDate : 2016-08-13 15:53:38
