...
import com.meidp.crmim.adapter.ContactsAdapter;
...
public class ContactsActivity extends BaseActivity implements AdapterView.OnItemClickListener, PullToRefreshBase.OnRefreshListener2<ListView> {
    ...
    public void onInit() {
        ...
        mAdapter = new ContactsAdapter(mDatas, ContactsActivity.this, activity);
    ...
    private void loadData(int pageIndex, String keyword) {
        ...
        HttpRequestUtils.getmInstance().send(ContactsActivity.this, Constant.CUSTOMER_CONTACTS_URL, params, new HttpRequestCallBack<String>() {
            @Override
