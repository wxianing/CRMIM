...
public class SPUtils {
    ...
    public static boolean getLoginTag(Context context) {
        return (boolean) get(context, "login", false);
    }

    public static void setLoginTag(Context context, boolean boo) {
        save(context, "login", boo);
    }
    ...
    public static String SceneList2String(List<Contact> SceneList) throws IOException {
    ...
    public static List<Contact> String2SceneList(String SceneListString) throws StreamCorruptedException, IOException, ClassNotFoundException {
        byte[] mobileBytes = Base64.decode(SceneListString.getBytes(),
                Base64.DEFAULT);
        ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(
                mobileBytes);
        ObjectInputStream objectInputStream = new ObjectInputStream(byteArrayInputStream);
        List<Contact> SceneList = (List) objectInputStream.readObject();
